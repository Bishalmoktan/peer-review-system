...
export default function CreateSubmission() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("/api/create-assignment", formData);

      if (!response) {
        throw new Error(response || "Failed to create assignment");
      }
    ...
    <div className="max-w-2xl py-10 mx-auto">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload your assignment as a PDF file (maximum size: 20MB)
          </CardDescription>
        </CardHeader>
